...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN1] = LAYOUT_60_ansi(
    ...
    _______, _______, _______, _______, _______, MN_DFU,  _______, _______, _______, _______, _______,                    _______,
    _______, _______, _______,                            _______,                            _______,  _______, _______, _______
  ),
};

// TODO:
//   - Selecting words keymaps:
//     - LALT + LSFT + arrows
//   - Moom keystrokes that don't work because of the lack of arrow keys:
//     - LCTL + LALT + LSFT + arrow up (replaced by rsft)
//     - LCTL + LALT + LSFT + arrow down (replaced by rctl)
//   - Test a way to trigger a layer with my left hand and type arrows with my right hand (e.g. KC_GRAVE or KC_TAB + HJKL)

...
#define MO_CONF  MO(_FL)           // Hold for function layer.
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├────────────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴──┬────┴───────┬───────┼───────┤
     * │               │       │       │       │       │       │       │       │       │       │       │            │       │       │
     * │     Shift     │   Z   │   X   │   C   │   V   │   B   │   N   │   M   │   ,   │   .   │   /   │ Shift/Slsh │  Up   │ PgDn  │
     * │               │       │       │       │       │       │       │       │       │       │       │            │       │       │
     * ├─────────┬─────┴───┬───┴─────┬─┴───────┴───────┴───────┴───────┴───────┴─────┬─┴───────┼───────┴─┬──┬───────┼───────┼───────┤
     * │         │         │         │                                               │         │         │▒▒│       │       │       │
    ...
    [_BL] = LAYOUT_65_ansi_blocker(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SHT_SLH,          KC_UP,   KC_PGDN, \
        KC_LCTL, KC_LALT, KC_LGUI,                            KC_SPC,                             KC_LGUI, MO_CONF, KC_LEFT, KC_DOWN, KC_RGHT  \
    ),
...
led_instruction_t led_instructions[] = {
    // Light up the first key to display which layer is active:
    // * In blue: Base layer.
    // * In red: Function layer.
    // Additionally, highlight "important" keys in the function layer:
    // * `B` in red for Bootloader mode.
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .layer = _BL, .b = 255, .id0 = 0x00000001, .id1 = 0x00000000 },
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_MATCH_LAYER | LED_FLAG_USE_RGB, .layer = _FL, .r = 255, .id0 = 0x00000001, .id1 = 0x00020000 },
